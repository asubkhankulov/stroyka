            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="well well-sm">
					<a href="/doma/">Типы построек</a> / <a href="/doma/step/{$doma_id}/">{$info.name}</a> / <a href="/doma/works/{$step_id}/{$doma_id}/">{$info.step}</a> -  cписок работ:
				</div>                
  ...
  <div class="modal-dialog">
    <div class="modal-content modal-sm">
 	...
 	<div class="row">
		...
		<form class="form-horizontal text-primary" action="/doma/works/{$step_id}/{$doma_id}/" method="POST">
