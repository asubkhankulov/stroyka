<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		<div class="well well-sm">
			Редактирование записи / <a href="/sklad/">Группы складов</a> / Склад  - {$info.name}
		</div>   
		...
		<form class="form-horizontal text-primary" action="/sklad/{$info.mesto_id}/" method="POST">
			<input type="hidden" name="action" value="edit" />
			<input type="hidden" name="id" value="{$info.id}" />
		  <div class="form-group">
		    <label for="input1" class="col-sm-4 control-label hidden-xs">Наименование склада:</label>
		    <div class="col-sm-8">
