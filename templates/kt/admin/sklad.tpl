            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <h1 class="page-header">Группы складов</h1>
                    ...
                    <table class="table table-striped table-bordered table-list">
                        ...
                        {section name=cus loop=$list}
                            <tr id="cnt_{$list[cus].id}">
                                ...
                                <td><a href="/sklad/{$list[cus].id}/">{$list[cus].kol}</a></td>
...
<hr>
		...
		<form class="form-horizontal text-primary" action="/sklad/" method="POST">
			<input type="hidden" name="action" value="add" />
		  <div class="form-group">
		    <label for="input1" class="col-sm-4 control-label hidden-xs">Наименование группы:</label>
		    <div class="col-sm-8">
