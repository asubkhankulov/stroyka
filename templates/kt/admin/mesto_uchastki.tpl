<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	<div class="well well-sm">
		<a href="/mesto/">Посёлки</a> / {$info.name}  - cписок участков:
	</div>                
                    ...
                    <table class="table table-striped table-bordered table-list">
                        <thead>
                            <tr>
                                ...
                                <th align="center">Ширина</th>
                                <th align="center">Септик</th>
                                <th align="center">Вода</th>
...
<hr>
		<h4>Добавление нового участка  в посёлке <span class="label label-warning">{$info.name}</span>:</h4>
	
		<form class="form-horizontal text-primary" action="/mesto/{$info.id}/" method="POST">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-8">
		      <input type="text" class="form-control" name="shir" placeholder="">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="septik" class="col-sm-4 control-label hidden-xs">Септик</label>
		    <div class="col-sm-8">
		      <input type="text" class="form-control" name="septik" placeholder="">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="voda" class="col-sm-4 control-label hidden-xs">Вода:</label>
		    <div class="col-sm-8">
		      <input type="text" class="form-control" name="voda" placeholder="">
		    </div>
		  </div>
		  <div class="form-group">
